        ...
        private static readonly HashSet<(System.Type, System.Type)> incompatibleDataAttributes = new()
            {
                ...
                (typeof(BuiltinContext) , typeof(AlignedContext)) ,
                (typeof(BuiltinContext) , typeof(AsContext)) ,
                (typeof(BuiltinContext) , typeof(BitContext)) ,
                (typeof(BuiltinContext) , typeof(EntryContext)) ,
                (typeof(BuiltinContext) , typeof(IntegerContext)) ,
                (typeof(BuiltinContext) , typeof(LabelContext)) ,
                (typeof(BuiltinContext) , typeof(PointerContext)) ,
