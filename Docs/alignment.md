...
A bit data type too has a default alignemnt of 1 byte. If you declare a variabel to be `bit(3)` or `bit47` the variable will be aligned on a byte boundary, the `0th` bit being aligned with bit 0 of the byte. 
